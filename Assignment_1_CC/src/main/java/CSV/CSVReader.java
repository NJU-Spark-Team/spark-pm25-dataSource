...
public class CSVReader {
    ...
    private static final String defaultPath = "C:\\Users\\Disclover\\Desktop\\Data";
    ...
    public static void main(String[] args) {
        readAndClear(defaultPath);
    }

    public static void readAndClear(String path) {
        int cnt = 0;
        ...
        try {
            for (int i = 0; i < 5; i++) {
                readers[i] = new BufferedReader(new InputStreamReader(new FileInputStream(path + "/" + fileName[i] + ".csv"), "UTF-8"));
            }
            for (int i = 0; i < 5; i++) {
